...
class Wxpayqrcode implements Payment{
    ...
    public function getPaymentCode($order,$parameters = array()){
        ...
        $result['orderid'] = $parameters['out_trade_no'];
        $result['url'] = 'http://paysdk.weixin.qq.com/example/qrcode.php?data='.$order['code_url'];
        $result['cachekey'] = $parameters['attach'];
        return $result;
    }
...
class PayNotifyCallBack extends WxPayNotify{
    ...
    public function NotifyProcess($data, &$msg){
        ...
        //处理订单回调
        $order = Transaction::notifyOrder($data['out_trade_no'],$data['transaction_id']);
