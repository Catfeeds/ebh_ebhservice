...
class SliderController extends Controller{
    ...
    public function addAction(){
        ...
        $appSliersModel = new AppSlidersModel();
        $result = $appSliersModel->add($parameters);
        if($result > 0){
    ...
    public function editAction(){
        ...
        $appSliersModel = new AppSlidersModel();
        $result = $appSliersModel->edit($parameters);
    ...
    public function delAction(){
        $appSliersModel = new AppSlidersModel();
        $result = $appSliersModel->del($this->id,$this->crid);
