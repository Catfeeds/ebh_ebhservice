...
class AppNavigationsModel {
    ...
    public function add($parameters){
        return Ebh()->db->insert('ebh_app_navigations',$parameters);
    }
    ...
    public function edit($parameters){
        ...
        return Ebh()->db->update('ebh_app_navigations',$updateParams, array('id' => intval($parameters['id'])));
    ...
    public function getCount($crid){
        $sql = 'select count(id) as count from ebh_app_navigations where crid = '.$crid;
    ...
    public function getList($crid,$parameters){
        $sql = 'select id,crid,name,image_url,url,type,link_value,displayorder from ebh_app_navigations';
    ...
    public function del($id,$crid){
        ...
        $sql = 'DELETE FROM `ebh_app_navigations` WHERE '.implode(' AND ', $where);
