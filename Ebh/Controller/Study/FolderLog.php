    ...
    public function getAction() {
        ...
        if (empty($folderStudyList)) {
            ...
            foreach ($totallogs as $folderid => $item) {
                $totallogs[$folderid]['ltime'] = isset($folderStudyList[$folderid]['ltime']) ? $folderStudyList[$folderid]['ltime'] : 0;
                $totallogs[$folderid]['totalltime'] = isset($folderStudyList[$folderid]['totalltime']) ? $folderStudyList[$folderid]['totalltime'] : 0;//国土学习记录
            }
        }
        return $totallogs;
